...
export default function OrderDetails() {
  ...
  // useEffect(() => {
  //   try {
  //     dispatch(getCustomer(customer_id._id));
  //     setTimeout(() => {
  //       setIsLoading(false);
  //     }, 2000);
  //   } catch (error) {
  ...
  return !isLoading ? (
    <div className="container h-full flex-1 flex-col space-y-8 sm:p-8 p-4">
      ...
      <div className="flex lg:flex-row flex-col-reverse gap-6">
        <div className="flex rounded-lg flex-1 border flex-col">
            ...
            <div className="flex flex-col gap-2 ">
              <div className="flex gap-4 lg:justify-normal justify-between">
                ...
                <p className="font-medium text-md ">
                  {format(new Date(order?.order_item.date_from), "LLLL Do, y")}
                </p>
              </div>
              <div className="flex gap-4 lg:justify-normal justify-between">
          ...
          <div className="md:p-6 p-4">
            ...
            <div className="flex flex-col gap-2 ">
              ...
              <div className="flex gap-4 lg:justify-normal justify-between">
                <p className="font-light text-base  ">Rentlify service fee:</p>
                <p className="font-medium text-md">
                  {new Intl.NumberFormat("de-DE", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
            ...
            {/* <div className="flex flex-col gap-2 items-center">
              <div className="flex justify-between w-[450px]">
                ...
                <p className="font-medium text-md">
                  {order?.order_item.total_price} MAD
                </p>
              </div>
              <div className="flex justify-between w-[450px]">
                <p className="font-medium text-md">Rentlify service fee</p>
                <p className="font-medium text-md">
                  {(
                    order?.order_item.total_with_fees -
                    order?.order_item.total_price
              ...
              <div className="flex justify-between w-[450px]">
                ...
                <p className="font-medium text-md">
                  {order?.order_item.total_with_fees} MAD
                </p>
              </div>
            </div> */}
          </div>
