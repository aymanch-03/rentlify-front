...
export default function UpdateUserForm({ user }) {
    ...
    const editData = () => {
        ...
        // Set default values and mark fields as dirty
    ...
    const cancelEdit = () => {
        ...
        // Reset form values and mark fields as not dirty
    ...
    const submitData = (id, data) => {
        try {
            const updatedUser = form.getValues();
    ...
    return user ? (
        <div>
            <div className="flex justify-between items-center">
                ...
                <div>
                    <Button className={`p-4`} variant="outline" type="button" onClick={editData}>
                        EDIT
                    </Button>
                </div>
            </div>
            <Form {...form}>
                <form onSubmit={form.handleSubmit((data) => submitData(user._id, data))} className="space-y-6">
                    <FormField
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="flex">
                                <FormLabel className="w-[400px] text-slate-500 p-2">ACTIVE</FormLabel>
                                <div className="inline-block w-full">
                                    <Select name="active" value={user.active} disabled={isDisabled}>
                                        <FormControl >
                                            <>
                                                <SelectTrigger className="">
                                                    <SelectValue placeholder="Select a role to display" />
